...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 21095 or testnet: 11095)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 21095 or testnet: 11095)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Hellascoin Wiki for SSL setup instructions)") + "\n" +
